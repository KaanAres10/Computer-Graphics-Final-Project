...
struct BloomSettings {
    ...
    int kernelSize = 5;
    bool onlyBloom = false;
    bool onlyBloomGrayscale = false;
    MappingType mappingType = MappingType::Linear; // Default
};

struct DepthOfFieldSettings {
    float lendRadius = 0.1f;
...
struct ExtraFeatures {
    ...
    // DepthOfField-specific settings
