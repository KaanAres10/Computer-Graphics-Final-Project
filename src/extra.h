...
struct DebugRayData {
    std::vector<glm::vec3> lensPoints; // Lens points for debug visualization
    std::vector<glm::vec3> focalPoints; // Focal points for debug visualization
    std::vector<glm::vec3> imagePlanePoints; // Image plane points for visualization

    glm::vec3 cameraPosition; // Camera position
    glm::vec3 cameraForward; // Camera forward direction
    glm::vec3 cameraUp; // Camera up direction
};



extern DebugRayData debugData; // Declare the global variable
